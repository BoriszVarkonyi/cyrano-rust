...
pub fn decompose_msg(mut raw: &str) -> Result<Message, String> {
...
pub fn compose_hello(piste_number: String, competition_id: String) -> String {
...
pub fn compose_display(msg: Message) -> String {
